...
DROP POLICY IF EXISTS "admin_update_articulos" ON stock_articulos;
...
DROP POLICY IF EXISTS "admin_insert_movimientos" ON stock_movimientos;
...
DROP POLICY IF EXISTS "admin_update_movimientos" ON stock_movimientos;
...
DROP POLICY IF EXISTS "admin_insert_stock_ub" ON stock_por_ubicacion;
...
DROP POLICY IF EXISTS "admin_update_stock_ub" ON stock_por_ubicacion;
...
DROP POLICY IF EXISTS "admin_update_karting" ON inscripciones_karting;
...
DROP POLICY IF EXISTS "admin_update_turismo" ON inscripciones_turismo;
...
DROP POLICY IF EXISTS "admin_update_regularidad" ON inscripciones_regularidad;
