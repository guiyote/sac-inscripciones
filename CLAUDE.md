...
25-26 Apr · 13-14 Jun · 8-9 Aug · 19-20 Sep · 24-25 Oct · 20-21 Nov (Oct is diurna, Sat-Sun; Nov is nocturna, Fri-Sat)
...
Los reglamentos TNS (General y Mecánico) están en `reglamentos/2026/` (sí versionados) y se linkean discretamente debajo de la tarjeta de Resultados en `index.html`. Para actualizarlos, reemplazar el PDF manteniendo el nombre de archivo.
